...
mod test {
    ...
    fn test_one_by_one_push_dynamic() {
        ...
        let my_service: DynamicVectorManageService<StaticStruct> = VectorDatabase::<StaticStruct>::new(
            "cacheD1.bin".to_string(), "cacheDD1.bin".to_string(), 1024
        );
        for i in 0..COUNT {
            let my_obj: StaticStruct = StaticStruct {
                my_usize: 443 + i,
    ...
    fn test_getting_lot_static() {
        ...
        let my_service: StaticVectorManageService<StaticStruct> = VectorDatabase::<StaticStruct>::new(
            "cacheS3.bin".to_string(), "cacheSD3.bin".to_string(), 1024
        );
        for i in 0..COUNT {
            let my_obj: StaticStruct = StaticStruct {
                my_usize: 443 + i,
    ...
    fn test_getting_static_multi_turns() {
        ...
        // let my_service = StaticVectorManageService::<StaticStruct>::new(
        let my_service: StaticVectorManageService<StaticStruct> = VectorDatabase::<StaticStruct>::new(
            "cacheS4.bin".to_string(), "cacheSD4.bin".to_string(), 1024
        );
